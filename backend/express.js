...
//   const { name, phoneNumber,email, guests } = req.body; // Extract data from the request body
//   //create a mail options object i.e how the email will appear when sent 
//   const mailOptions = {
//       from: email,
...
//     //create a sendMail method that sends the email
